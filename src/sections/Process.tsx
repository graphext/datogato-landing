...
export function Process() {
  return (
    <div className="space-y-8" aria-labelledby="metodologia-title">
      ...
      <ol className="relative mt-6 space-y-10 pl-12 before:absolute before:left-[4.5rem] before:top-[1.5rem] before:bottom-[1.5rem] before:w-[3px] before:rounded-full before:bg-[#a04c2d]">
        {process.steps.map((step, index) => (
          <li key={step.title} className="relative flex items-start gap-6">
            ...
            <article className="flex-1 rounded-[32px] border border-[#d9b38a] bg-[#fdf2e3] p-6 shadow-[6px_10px_0_rgba(92,46,26,0.16)]">
